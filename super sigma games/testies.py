import pygame
import sys
# some of this stuff was made by ai specifically the draw board function. while everything else i just looked at the code of other chess games
pygame.init()
...
#defines the chesspeice and puts them in a group
class ChessPiece():
...
#loads the images in a bunch of rows iterates through the rows of the 8 by 8 board and loads the chess peices onto it.
def draw_piece():
    for row in range(8):
        for col in range(8):
            piece = board[row][col]
...
#if statements saying what every peice does and sets of rules that say what the peice does.
# sequencing
